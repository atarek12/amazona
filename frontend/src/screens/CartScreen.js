    ...
    return (
        <div className="cart">
                    ...
                    </li>
                    {
                        cartItems.length === 0 ?
                            ...
                            cartItems.map((item, index) =>
                                <li key={index}>
                                    <div className="cart-image"><img src={require(`../${item.image}`)} alt="product" /></div>
            ...
            <div className="cart-action">
                <h3>Subtotal ( {cartItems.reduce((a, c) => a + c.qty * 1, 0)} items):$ {cartItems.reduce((a, c) => a + c.price * c.qty, 0)}</h3>
